...
const subject = process.argv[2] || 'HowTo_groq'; //  Obtenir le sujet via l'argument de ligne de commande
...
const subjects = [
  "how-to-build_learn-with-groq-sdk",
...
async function main() {
  for (const subject of subjects) {
    try {
      ...
      const outputFilePath = `howTto_${subject}_` + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
