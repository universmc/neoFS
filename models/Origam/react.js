  ...
  for (const subject of subjects) {
    try {
      ...
      messages: [
        ...
        {role: "system", content:"Imaginez un machine à prompt pour créer le frontend /src/ avec ReactJs, les prompts pour la gestion du code ReacJs serons transformer pour le projet \" ./react.js \". Voici ## le contexte, ## Le dataset, HTML,SCSS,JS,JSX,JSON ++ ... ## les Variables, ## les parametres ## Les fonctions,## boucle éventuel ## vos tâches, ## votre processus, et ## les caractéristiques, inférence recherchées: ## Actions Immédiates ## le prompt ultime pour generé le code source ## le code source attendu "},
