...
const subject = process.argv[2] || 'ThreeJs'; //  Obtenir le sujet via l'argument de ligne de commande
    ...
    try {
      ...
      messages: [
        ...
        { role: "user", content: `${subject}`  },
         {role: "system", content:"Imaginez un machine à prompt pour la gestion du code source threeJs. les prompts ThreeJs serons transformer pour le projet \" ./three.js \". Voici ## le contexte, ## Le dataset, HTML,SCSS,JS,JSX,JSON ++ ... ## les Variables, ## les parametres ## Les fonctions,## boucle éventuel ## vos tâches, ## votre processus, et ## les caractéristiques, inférence recherchées: ## Actions Immédiates ## le prompt ultime pour generé le code source ## le code source attendu "},
